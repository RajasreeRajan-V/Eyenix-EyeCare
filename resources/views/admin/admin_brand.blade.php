                                        ...
                                        <tbody>
                                            @forelse($brands as $index => $brand)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($brand->img)
                                                            <img src="{{ asset('storage/' . $brand->img) }}" width="100"
                                                    ...
                                                    {{-- <td>
                                                        <span
                                                            class="badge {{ $brand->status ? 'badge-success' : 'badge-danger' }}">
...
<div class="modal fade" id="editBrandModal{{ $brand->id }}" tabindex="-1"
    aria-labelledby="editBrandLabel{{ $brand->id }}" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.brand.update', $brand->id) }}"
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="editBrandLabel{{ $brand->id }}">
                        Edit Brand
                    </h5>
